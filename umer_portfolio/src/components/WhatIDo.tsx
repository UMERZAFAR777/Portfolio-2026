...
const WhatIDo = () => {
  ...
  <h3>FRONTEND</h3>
  <h4>Building User-Friendly Interfaces</h4>
  <p>
    Creating responsive and interactive user interfaces with modern web technologies.
    Focused on performance, usability, and seamless user experience across devices.
  </p>
  ...
  <div className="what-arrow"></div>
          ...
          >
            ...
            <div className="what-content-in">
  <h3>BACKEND</h3>
  <h4>Python Django Development</h4>
  <p>
    Developing scalable web applications using Python and Django.
    Experienced in building REST APIs, handling databases, and implementing
